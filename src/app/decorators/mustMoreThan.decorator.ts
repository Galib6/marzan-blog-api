import { buildMessage, isNumber, registerDecorator, ValidationOptions } from 'class-validator';
...
export function MustMoreThan(minVal: number, validationOptions?: ValidationOptions) {
