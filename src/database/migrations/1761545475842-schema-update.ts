...
export class SchemaUpdate1761545475842 implements MigrationInterface {
  name = 'SchemaUpdate1761545475842';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdById" uuid NOT NULL, "updatedById" uuid NOT NULL, "title" character varying(500), "description" text, "slug" character varying NOT NULL, "orderPriority" integer DEFAULT '0', CONSTRAINT "UQ_420d9f679d41281f282f5bc7d09" UNIQUE ("slug"), CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_aa79448dc3e959720ab4c13651" ON "categories" ("title") `
    );
    await queryRunner.query(
      `CREATE TABLE "articles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdById" uuid NOT NULL, "updatedById" uuid NOT NULL, "title" character varying(500), "name" character varying(256) NOT NULL, "summary" character varying NOT NULL, "thumb" character varying(256) NOT NULL, "content" jsonb NOT NULL, "slug" character varying NOT NULL, "orderPriority" integer DEFAULT '0', CONSTRAINT "UQ_1123ff6815c5b8fec0ba9fec370" UNIQUE ("slug"), CONSTRAINT "PK_0a6e2c450d83e0b6052c2793334" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "banners" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdById" uuid NOT NULL, "updatedById" uuid NOT NULL, "orderPriority" integer DEFAULT '0', "articleId" uuid, CONSTRAINT "REL_ac7dfbdc3764d3fc666dcf92af" UNIQUE ("articleId"), CONSTRAINT "PK_e9b186b959296fcb940790d31c3" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "authors" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdById" uuid NOT NULL, "updatedById" uuid NOT NULL, "name" character varying(256) NOT NULL, "type" character varying(256) NOT NULL, "fb" character varying(256), "whatsapp" character varying(256), "linkedin" character varying(256), "youtube" character varying(256), "description" text, CONSTRAINT "PK_d2ed02fabd9b52847ccb85e6b88" PRIMARY KEY ("id"))`
    );
